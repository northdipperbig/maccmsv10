...
<div class="fed-part-layout fed-back-whits fed-part-height">
	<div class="fed-user-login fed-part-core">
		...
		<form class="fed-user-form fed-user-width fed-part-rows" action="<?php echo mac_url('user/reg'); ?>" data-jump="<?php echo mac_url('user/login'); ?>">
