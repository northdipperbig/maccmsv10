...
<div class="fed-rank-info fed-part-layout fed-part-rows fed-back-whits">
	<div class="fed-list-head fed-part-rows fed-padding">
		<h2 class="fed-font-xvi">排行榜</h2>
	...
	<?php $__TAG__ = '{"ids":"parent","order":"asc","by":"sort","flag":"vod","id":"vfed","key":"key"}';$__LIST__ = model("Type")->listCacheData($__TAG__); if(is_array($__LIST__['list']) || $__LIST__['list'] instanceof \think\Collection || $__LIST__['list'] instanceof \think\Paginator): $key = 0; $__LIST__ = $__LIST__['list'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vfed): $mod = ($key % 2 );++$key;?>
	<div class="fed-list-info fed-list-rank fed-part-rows fed-padding fed-col-xs4">
		<h2 class="fed-list-head fed-part-rows fed-font-xvi"><?php echo $vfed['type_name']; ?><a class="fed-part-tips fed-font-xiv" href="<?php echo mac_url_type($vfed); ?>">更多</a></h2>
		<ul>
			<?php $__TAG__ = '{"num":"10","type":"'.$vfed['type_id'].'","order":"desc","by":"hits_day","id":"vo","key":"key"}';$__LIST__ = model("Vod")->listCacheData($__TAG__); if(is_array($__LIST__['list']) || $__LIST__['list'] instanceof \think\Collection || $__LIST__['list'] instanceof \think\Paginator): $key = 0; $__LIST__ = $__LIST__['list'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($key % 2 );++$key;?>
	...
	<?php endforeach; endif; else: echo "" ;endif; ?>
	<div class="fed-part-both"></div>
	<?php $__TAG__ = '{"ids":"child","order":"asc","by":"sort","flag":"vod","id":"vfed","key":"key"}';$__LIST__ = model("Type")->listCacheData($__TAG__); if(is_array($__LIST__['list']) || $__LIST__['list'] instanceof \think\Collection || $__LIST__['list'] instanceof \think\Paginator): $key = 0; $__LIST__ = $__LIST__['list'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vfed): $mod = ($key % 2 );++$key;?>
	<div class="fed-list-info fed-list-rank fed-part-rows fed-padding fed-col-xs4">
		<h2 class="fed-list-head fed-part-rows fed-font-xvi"><?php echo $vfed['type_name']; ?><a class="fed-part-tips fed-font-xiv" href="<?php echo mac_url_type($vfed); ?>">更多</a></h2>
		<ul>
			<?php $__TAG__ = '{"num":"10","type":"'.$vfed['type_id'].'","order":"desc","by":"hits_day","id":"vo","key":"key"}';$__LIST__ = model("Vod")->listCacheData($__TAG__); if(is_array($__LIST__['list']) || $__LIST__['list'] instanceof \think\Collection || $__LIST__['list'] instanceof \think\Paginator): $key = 0; $__LIST__ = $__LIST__['list'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($key % 2 );++$key;?>
