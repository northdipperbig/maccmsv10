<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:71:"/www/wwwroot/www.m9628.com/application/admin/view/system/configurl.html";i:1588574037;s:66:"/www/wwwroot/www.m9628.com/application/admin/view/public/head.html";i:1588574037;s:66:"/www/wwwroot/www.m9628.com/application/admin/view/public/foot.html";i:1588574037;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    <form class="layui-form layui-form-pane" action="">
        <div class="layui-tab" lay-filter="tb1">
            <ul class="layui-tab-title">
                <li class="layui-this" lay-id="configurl_1">浏览模式设置</li>
                <li class="" lay-id="configurl_2">静态路径设置</li>
                <li class="" lay-id="configurl_3">路由伪静态设置</li>
            </ul>
            <div class="layui-tab-content">
                ...
                <div class="layui-tab-item">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline w500">
                            变量：{id} {en} {type_pid} {type_pen} {md5}
                        </div>
                    </div>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline w600">
                            变量：{id} {en} {type_id} {type_en} {type_pid} {type_pen} {year} {month} {day} {md5}
                        </div>
                    </div>
                ...
                <div class="layui-tab-item">
                    ...
                    <div class="layui-form-item">
                        ...
                        <label class="layui-form-label">网址ID：</label>
                        <div class="layui-input-inline w100">
                            <select name="rewrite[website_id]" >
                                <option value="0" <?php if($config['rewrite']['website_id'] == 0): ?>selected<?php endif; ?>>数字ID</option>
                                <option value="1" <?php if($config['rewrite']['website_id'] == 1): ?>selected<?php endif; ?>>拼音</option>
                            </select>
                        </div>
