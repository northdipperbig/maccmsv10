...
<li class="fed-swip-slide">
<a class="fed-list-pics fed-part-5by2 fed-swip-lazy" href="<?php echo mac_url_topic_detail($vo); ?>" data-background="<?php echo mac_url_img(mac_default($vo['topic_pic_slide'],$vo['topic_pic'])); ?>">
<div class="fed-swip-title fed-text-white fed-part-eone">
...
<div class="fed-list-new fed-part-layout fed-back-whits">
	...
	<ul class="fed-list-info fed-list-img fed-part-rows">
		...
		<a class="fed-list-pics fed-lazy fed-part-5by3" href="<?php echo mac_url_vod_detail($vo); ?>" data-original="<?php echo mac_url_img($vo['vod_pic']); ?>">
...
<dt>地区</dt>
<?php if(empty($obj['type_extend']['area']) || (($obj['type_extend']['area'] instanceof \think\Collection || $obj['type_extend']['area'] instanceof \think\Paginator ) && $obj['type_extend']['area']->isEmpty())): $_5eafe24af321f=explode(',',$obj['parent']['type_extend']['area']); if(is_array($_5eafe24af321f) || $_5eafe24af321f instanceof \think\Collection || $_5eafe24af321f instanceof \think\Paginator): if( count($_5eafe24af321f)==0 ) : echo "" ;else: foreach($_5eafe24af321f as $key=>$vo): ?>
...
<?php endforeach; endif; else: echo "" ;endif; else: $_5eafe24af3210=explode(',',$obj['type_extend']['area']); if(is_array($_5eafe24af3210) || $_5eafe24af3210 instanceof \think\Collection || $_5eafe24af3210 instanceof \think\Paginator): if( count($_5eafe24af3210)==0 ) : echo "" ;else: foreach($_5eafe24af3210 as $key=>$vo): ?>
<dd<?php if($key>9): ?> class="fed-hide-sm"<?php endif; ?>><a href="<?php echo mac_url_type($obj,['area'=>$vo,'lang'=>$param['lang'],'year'=>$param['year']],'show'); ?>"><?php echo $vo; ?></a></dd>
<?php endforeach; endif; else: echo "" ;endif; endif; ?>
</dl>
<dl class="fed-col-sx12 fed-col-sm6 fed-col-md4">
<dt>年代</dt>
<?php if(empty($obj['type_extend']['year']) || (($obj['type_extend']['year'] instanceof \think\Collection || $obj['type_extend']['year'] instanceof \think\Paginator ) && $obj['type_extend']['year']->isEmpty())): $_5eafe24af31ed=explode(',',$obj['parent']['type_extend']['year']); if(is_array($_5eafe24af31ed) || $_5eafe24af31ed instanceof \think\Collection || $_5eafe24af31ed instanceof \think\Paginator): if( count($_5eafe24af31ed)==0 ) : echo "" ;else: foreach($_5eafe24af31ed as $key=>$vo): ?>
...
<?php endforeach; endif; else: echo "" ;endif; else: $_5eafe24af31de=explode(',',$obj['type_extend']['year']); if(is_array($_5eafe24af31de) || $_5eafe24af31de instanceof \think\Collection || $_5eafe24af31de instanceof \think\Paginator): if( count($_5eafe24af31de)==0 ) : echo "" ;else: foreach($_5eafe24af31de as $key=>$vo): ?>
<dd<?php if($key>9): ?> class="fed-hide-sm"<?php endif; ?>><a href="<?php echo mac_url_type($obj,['area'=>$param['area'],'lang'=>$param['lang'],'year'=>$vo],'show'); ?>"><?php echo $vo; ?></a></dd>
<?php endforeach; endif; else: echo "" ;endif; endif; ?>
</dl>
<dl class="fed-col-sx12 fed-col-sm6 fed-col-md4 fed-hide-sm fed-show-md-block">
<dt>语言</dt>
<?php if(empty($obj['type_extend']['lang']) || (($obj['type_extend']['lang'] instanceof \think\Collection || $obj['type_extend']['lang'] instanceof \think\Paginator ) && $obj['type_extend']['lang']->isEmpty())): $_5eafe24af31bc=explode(',',$obj['parent']['type_extend']['lang']); if(is_array($_5eafe24af31bc) || $_5eafe24af31bc instanceof \think\Collection || $_5eafe24af31bc instanceof \think\Paginator): if( count($_5eafe24af31bc)==0 ) : echo "" ;else: foreach($_5eafe24af31bc as $key=>$vo): ?>
...
<?php endforeach; endif; else: echo "" ;endif; else: $_5eafe24af31ac=explode(',',$obj['type_extend']['lang']); if(is_array($_5eafe24af31ac) || $_5eafe24af31ac instanceof \think\Collection || $_5eafe24af31ac instanceof \think\Paginator): if( count($_5eafe24af31ac)==0 ) : echo "" ;else: foreach($_5eafe24af31ac as $key=>$vo): ?>
<dd<?php if($key>9): ?> class="fed-hide-sm"<?php endif; ?>><a href="<?php echo mac_url_type($obj,['area'=>$param['area'],'lang'=>$vo,'year'=>$param['year']],'show'); ?>"><?php echo $vo; ?></a></dd>
<?php endforeach; endif; else: echo "" ;endif; endif; ?>
</dl>
</div>
...
<li class="fed-swip-slide">
<a class="fed-list-pics fed-part-3by2 fed-swip-lazy" href="<?php echo mac_url_topic_detail($vo); ?>" data-background="<?php echo mac_url_img(mac_default($vo['topic_pic_slide'],$vo['vod_pic'])); ?>">
<div class="fed-swip-title fed-text-white fed-part-eone">
<span class="fed-part-eone fed-font-xviii fed-swip-head"><?php echo $vo['topic_name']; ?></span>
<span class="fed-part-eone fed-font-xii"><?php echo mac_default($vo['topic_remarks'],'内详'); ?></span>
</div>
...
<?php endforeach; endif; else: echo "" ;endif; if($snum==0): $__TAG__ = '{"num":"6","paging":"no","type":"all","level":"0","order":"desc","by":"sort","start":"90","id":"vo","key":"key"}';$__LIST__ = model("Vod")->listCacheData($__TAG__); if(is_array($__LIST__['list']) || $__LIST__['list'] instanceof \think\Collection || $__LIST__['list'] instanceof \think\Paginator): $key = 0; $__LIST__ = $__LIST__['list'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($key % 2 );++$key;?>
<li class="fed-swip-slide">
<a class="fed-list-pics fed-part-3by2 fed-swip-lazy" href="<?php echo mac_url_vod_detail($vo); ?>" data-background="<?php echo mac_url_img($vo['vod_pic']); ?>">
<div class="fed-swip-title fed-text-white fed-part-eone">
<span class="fed-part-eone fed-font-xviii fed-swip-head"><?php echo $vo['vod_name']; ?></span>
...
<dl class="fed-col-sx12 fed-col-sm6 fed-col-md4">
<dt>地区</dt>
<?php if(empty($obj['type_extend']['area']) || (($obj['type_extend']['area'] instanceof \think\Collection || $obj['type_extend']['area'] instanceof \think\Paginator ) && $obj['type_extend']['area']->isEmpty())): $_5eafe24af30f4=explode(',',$obj['parent']['type_extend']['area']); if(is_array($_5eafe24af30f4) || $_5eafe24af30f4 instanceof \think\Collection || $_5eafe24af30f4 instanceof \think\Paginator): if( count($_5eafe24af30f4)==0 ) : echo "" ;else: foreach($_5eafe24af30f4 as $key=>$vo): ?>
<dd<?php if($key>9): ?> class="fed-hide-sm"<?php endif; ?>><a href="<?php echo mac_url_type($obj,['area'=>$vo,'lang'=>$param['lang'],'year'=>$param['year']],'show'); ?>"><?php echo $vo; ?></a></dd>
<?php endforeach; endif; else: echo "" ;endif; else: $_5eafe24af30e5=explode(',',$obj['type_extend']['area']); if(is_array($_5eafe24af30e5) || $_5eafe24af30e5 instanceof \think\Collection || $_5eafe24af30e5 instanceof \think\Paginator): if( count($_5eafe24af30e5)==0 ) : echo "" ;else: foreach($_5eafe24af30e5 as $key=>$vo): ?>
<dd<?php if($key>9): ?> class="fed-hide-sm"<?php endif; ?>><a href="<?php echo mac_url_type($obj,['area'=>$vo,'lang'=>$param['lang'],'year'=>$param['year']],'show'); ?>"><?php echo $vo; ?></a></dd>
<?php endforeach; endif; else: echo "" ;endif; endif; ?>
</dl>
<dl class="fed-col-sx12 fed-col-sm6 fed-col-md4">
<dt>年代</dt>
<?php if(empty($obj['type_extend']['year']) || (($obj['type_extend']['year'] instanceof \think\Collection || $obj['type_extend']['year'] instanceof \think\Paginator ) && $obj['type_extend']['year']->isEmpty())): $_5eafe24af30c1=explode(',',$obj['parent']['type_extend']['year']); if(is_array($_5eafe24af30c1) || $_5eafe24af30c1 instanceof \think\Collection || $_5eafe24af30c1 instanceof \think\Paginator): if( count($_5eafe24af30c1)==0 ) : echo "" ;else: foreach($_5eafe24af30c1 as $key=>$vo): ?>
<dd<?php if($key>9): ?> class="fed-hide-sm"<?php endif; ?>><a href="<?php echo mac_url_type($obj,['area'=>$param['area'],'lang'=>$param['lang'],'year'=>$vo],'show'); ?>"><?php echo $vo; ?></a></dd>
<?php endforeach; endif; else: echo "" ;endif; else: $_5eafe24af30b2=explode(',',$obj['type_extend']['year']); if(is_array($_5eafe24af30b2) || $_5eafe24af30b2 instanceof \think\Collection || $_5eafe24af30b2 instanceof \think\Paginator): if( count($_5eafe24af30b2)==0 ) : echo "" ;else: foreach($_5eafe24af30b2 as $key=>$vo): ?>
<dd<?php if($key>9): ?> class="fed-hide-sm"<?php endif; ?>><a href="<?php echo mac_url_type($obj,['area'=>$param['area'],'lang'=>$param['lang'],'year'=>$vo],'show'); ?>"><?php echo $vo; ?></a></dd>
<?php endforeach; endif; else: echo "" ;endif; endif; ?>
</dl>
<dl class="fed-col-sx12 fed-col-sm6 fed-col-md4 fed-hide-sm fed-show-md-block">
<dt>语言</dt>
<?php if(empty($obj['type_extend']['lang']) || (($obj['type_extend']['lang'] instanceof \think\Collection || $obj['type_extend']['lang'] instanceof \think\Paginator ) && $obj['type_extend']['lang']->isEmpty())): $_5eafe24af308c=explode(',',$obj['parent']['type_extend']['lang']); if(is_array($_5eafe24af308c) || $_5eafe24af308c instanceof \think\Collection || $_5eafe24af308c instanceof \think\Paginator): if( count($_5eafe24af308c)==0 ) : echo "" ;else: foreach($_5eafe24af308c as $key=>$vo): ?>
<dd<?php if($key>9): ?> class="fed-hide-sm"<?php endif; ?>><a href="<?php echo mac_url_type($obj,['area'=>$param['area'],'lang'=>$vo,'year'=>$param['year']],'show'); ?>"><?php echo $vo; ?></a></dd>
<?php endforeach; endif; else: echo "" ;endif; else: $_5eafe24af307b=explode(',',$obj['type_extend']['lang']); if(is_array($_5eafe24af307b) || $_5eafe24af307b instanceof \think\Collection || $_5eafe24af307b instanceof \think\Paginator): if( count($_5eafe24af307b)==0 ) : echo "" ;else: foreach($_5eafe24af307b as $key=>$vo): ?>
<dd<?php if($key>9): ?> class="fed-hide-sm"<?php endif; ?>><a href="<?php echo mac_url_type($obj,['area'=>$param['area'],'lang'=>$vo,'year'=>$param['year']],'show'); ?>"><?php echo $vo; ?></a></dd>
<?php endforeach; endif; else: echo "" ;endif; endif; ?>
</dl>
</div>
