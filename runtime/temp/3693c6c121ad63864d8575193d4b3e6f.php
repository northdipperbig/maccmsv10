...
<div class="fed-part-rows">
	...
	<dt class="fed-deta-images fed-list-info fed-col-xs3">
		<a class="fed-list-pics fed-lazy fed-part-16by9" href="<?php echo mac_url_art_detail($vo); ?>" data-original="<?php echo mac_url_img($vo['art_pic']); ?>"></a>
	</dt>
